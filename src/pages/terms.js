...
export default function Terms() {
  return (
    <div className="pt-40 pr-15 container pl-20 pb-20 text-justify leading-relaxed tracking-normal text-wrap ">
      <h2 className="text-3xl text-center py-8 uppercase ">
      ...
      <p className="text-base text-left py-2 ">
        These terms and conditions outline the rules and regulations for the use
        of Esthete Cleaning&apos;s Website, located at{" "}
        <Link
          className="underline underline-offset-4 hover:text-gray-700 px-1"
          href="https://www.esthetecleaning.us.">
          @esthetecleaning.us/
        </Link>
      </p>
      ...
      <p className="text-base text-left py-2 ">
        ...
        conditions. Do not continue to use Esthete Cleaning if you do not agree
      ...
      <h3 className="text-2xl text-left py-8 capitalize ">
        <strong>Cookies</strong>
      </h3>

      <p className="text-base text-left py-2 ">
        We employ the use of cookies. By accessing Esthete Cleaning , you agreed
        to use cookies in agreement with the Esthete Cleaning&apos;s Privacy
        Policy.{" "}
      </p>
      ...
      <p className="text-base py-2 text-justify ">
        Unless otherwise stated, Esthete Cleaning and/or its licensors own the
        intellectual property rights for all material on Esthete Cleaning . All
        intellectual property rights are reserved. You may access this from
        Esthete Cleaning for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p className="text-base py-2 text-justify ">You must not:</p>
      <ul className="list-decimal list-inside text-base py-4 leading-2 tracking-normal text-left nowrap">
        <li className="first-letter:uppercase ">
          Republish material from Esthete Cleaning{" "}
        </li>
        <li className="first-letter:uppercase ">
          Sell, rent or sub-license material from Esthete Cleaning{" "}
        </li>
        <li className="first-letter:uppercase ">
          Reproduce, duplicate or copy material from Esthete Cleaning{" "}
        </li>
        <li className="first-letter:uppercase ">
          Redistribute content from Esthete Cleaning{" "}
        </li>
      </ul>
      ...
      <p className="text-base py-2 text-justify ">
        ...
        <Link
          className="underline underline-offset-4 hover:text-gray-700 px-1"
          href="https://www.termsandconditionsgenerator.
com/">
      ...
      <p className="text-base py-2 text-justify ">
        ...
        Esthete Cleaning does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Esthete Cleaning,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Esthete Cleaning
      ...
      <p className="text-base py-2 text-justify ">
        Esthete Cleaning reserves the right to monitor all Comments and to
      ...
      <p className="text-base py-2 text-justify ">
        You hereby grant Esthete Cleaning a non-exclusive license to use,
      ...
      <ul className="list-decimal list-inside text-base py-4 leading-2 tracking-normal text-left nowrap">
        <li className="first-letter:uppercase ">Government agencies;</li>
        <li className="first-letter:uppercase ">Search engines;</li>
        <li className="first-letter:uppercase ">News organizations;</li>
        <li className="first-letter:uppercase ">
      ...
      <ul className="list-decimal list-inside text-base py-4 leading-2 tracking-normal text-left nowrap">
        ...
        <li className="first-letter:uppercase ">dot.com community sites;</li>
        <li className="first-letter:uppercase ">
        ...
        <li className="first-letter:uppercase ">internet portals;</li>
        <li className="first-letter:uppercase ">
      ...
      <p className="text-base py-2 text-justify ">
        ...
        the hyperlink compensates the absence of Esthete Cleaning; and (d) the
      ...
      <p className="text-base py-2 text-justify ">
        ...
        e-mail to Esthete Cleaning. Please include your name, your organization
      ...
      <p className="text-base py-2 text-justify ">
        No use of Esthete Cleaning&apos;s logo or other artwork will be allowed

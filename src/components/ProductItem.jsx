...
const ProductItem = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="border rounded-md p-4 mb-4 text-base prose space-y-0 ">
      <h3>{product.name}</h3>
      {product.image && (
        <img
          src={product.image}
      ...
      <p className="py-1">Price: ${product.price} per hour</p>

      <p className="py-1">
        Click to learn more about {product.name} <br />
